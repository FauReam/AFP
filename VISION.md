# AMP (Agentic Mutual Protocol) — 核心愿景

> **AMP 是一种去中心化的 P2P 互学习协议。模型不再被动接受聚合，而是像学者一样——通过"权重论文"交流知识，自主决定学什么、学多少、信谁。**
...
## 二、AMP 的核心思想：从"优化问题"到"学习问题"

### 范式对比

| | 现行 FL (FedAvg 范式) | AMP (Agentic Mutual Protocol) |
|---|---|---|
...
- 固定 trust（预设双方可信）
- 对比：AMP 选择性子空间更新 vs FedAvg 线性平均
- **核心指标**：AMP 是否在各自私有数据上的表现优于 FedAvg？
...
- FCL-PRM 的**实验数据**可作为 AMP 的 baseline 对比

**AMP 不是 FCL-PRM 的延续——它是一个全新的范式。FCL-PRM 试图诊断一个已有系统中的问题，AMP 试图重新定义系统本身。**
