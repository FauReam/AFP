...
\item \textbf{Cross-architecture replication (see \S\ref{sec:opt}): OPT-1.3B confirms domain stability gradient (medical 0.896 > code 0.251), but 9 scans (vs. 50+ for Pythia) is a minimal viability check, not a full replication.
