...
\item \textbf{Hessian eigenvalue estimation}: We attempted finite-difference power iteration but the estimator produced unphysical negative eigenvalues at this model scale, making the estimates unreliable. The method is removed from the paper.
\end{enumerate}
